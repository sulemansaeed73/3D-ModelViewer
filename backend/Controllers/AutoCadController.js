...
module.exports = {
  ...
  async checker(req, res) {
    ...
    // const objectId = `urn:adsk.objects:os.object:1megopvvpbqiuvkmqd3oxhomiawyiq2rmbc7j5yyg7ydaysa-basic-app/architectural_example-imperial.dwg`;
    const buf = Buffer.from(objectId, "ascii");
    const urn = buf.toString("base64").replace(/=+$/, "");
    // const urn = Buffer(objectId).toString("base64");
    console.log("Correct URN:", urn);
